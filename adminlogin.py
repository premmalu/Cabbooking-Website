    ...
    <div class="main">
        <section class="content">
            <form autocomplete="off">
                ...
                <a href="adminforgotpassword.py">forgot password?</a><br><br>
...
if v != None:
    ...
    cur.execute(q)
    r = cur.fetchone()                  #To fetch loggin details.
    if r != None:                       #check the loggin suxcess part.
        print("""
                    <script>
                        location.href = "adminpage.py?id=%s";
                    </script>
                """ % (r[0]))
    else:
        print("""
